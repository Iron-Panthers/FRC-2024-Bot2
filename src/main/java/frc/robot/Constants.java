...
public final class Constants {
        ...
        public static final class Drive {
                ...
                public static final class Dims {
                        ...
                        public static final double TRACKWIDTH_METERS = .5207; // 20.5 inches (source: cad) converted to
                                                                              // meters
                ...
                public static final class Modules {
                        public static final class Params {
                                ...
                                public static final Slot0Configs DRIVE_MOTOR_GAINS = new Slot0Configs().withKP(3)
                                                .withKI(0).withKD(0)
                                                .withKS(0.32).withKV(0.11).withKA(0);
                                public static final Slot0Configs STEER_MOTOR_GAINS = new Slot0Configs().withKP(11)
                                                .withKI(0).withKD(0)
        ...
        public static final class Pivot {
                ...
                public static final class MotorConfigs {
                        ...
                        public static final VoltageConfigs PIVOT_VOLTAGE = new VoltageConfigs()
        ...
        public static final class AutoAlign {
                ...
                public static final Pose2d BLUE_TOP_MID = new Pose2d(5.8, 7.0,
                                Rotation2d.fromDegrees(-TOP_MID_ANGLE + 180));

                // These poses have been verified
                public static final Pose2d BLUE_STAGE = new Pose2d(4.17, 4.74,
                                Rotation2d.fromDegrees(-STAGE_ANGLE + 180));
                public static final Pose2d BLUE_BOTTOM_MID = new Pose2d(5.84, 1.18,
                                Rotation2d.fromDegrees(-BOTTOM_MID_ANGLE + 180));

                // Red team:
                // These poses have not been verified
                public static final Pose2d RED_AMP = new Pose2d(FIELD_WIDTH - 2.75, 7.31,
                                Rotation2d.fromDegrees(-AMP_ANGLE));
