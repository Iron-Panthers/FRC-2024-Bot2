...
public final class Constants {
    ...
    public static final class Shooter {
        ...
        public static final class Modes {
            public static final ShooterSubsystem.ShooterPowers INTAKE = new ShooterSubsystem.ShooterPowers(76, 1, 0, 0);
            public static final ShooterSubsystem.ShooterPowers IDLE = new ShooterSubsystem.ShooterPowers(0, 0, 0, 0);
            public static final ShooterSubsystem.ShooterPowers RAMP_SPEAKER = new ShooterSubsystem.ShooterPowers(76, 1,
                    0, 0);
            public static final ShooterSubsystem.ShooterPowers RAMP_AMP_BACK = new ShooterSubsystem.ShooterPowers(25,
                    0.4, 0, 0);
            public static final ShooterSubsystem.ShooterPowers RAMP_AMP_FRONT = new ShooterSubsystem.ShooterPowers(0, 0,
                    0, 0);
            public static final ShooterSubsystem.ShooterPowers SHOOT_SPEAKER = new ShooterSubsystem.ShooterPowers(76, 1,
                    .5, 0);
            public static final ShooterSubsystem.ShooterPowers TARGET_LOCK = new ShooterSubsystem.ShooterPowers(0, 1, 0,
                    0);
            public static final ShooterSubsystem.ShooterPowers SHOOT_AMP_BACK = new ShooterSubsystem.ShooterPowers(25,
                    0.4, .5, 0);
            public static final ShooterSubsystem.ShooterPowers SHOOT_AMP_FORWARD = new ShooterSubsystem.ShooterPowers(8,
                    2.5, .5, 0);
            public static final ShooterSubsystem.ShooterPowers MAINTAIN_VELOCITY = new ShooterSubsystem.ShooterPowers(
                    40, 1, 0, 0);
            public static final ShooterSubsystem.ShooterPowers SHUTTLE = new ShooterSubsystem.ShooterPowers(30, 1, 0,
                    0);
            public static final ShooterSubsystem.ShooterPowers SHOOT_SHUTTLE = new ShooterSubsystem.ShooterPowers(30, 1,
                    0.5, 0);
            public static final ShooterSubsystem.ShooterPowers ACCEL_SECURE = new ShooterSubsystem.ShooterPowers(76, 1,
                    0.5, 0);
            public static final ShooterSubsystem.ShooterPowers VARIABLE_VELOCITY = new ShooterSubsystem.ShooterPowers(
                    30, 1, 0, 0);
            public static final ShooterSubsystem.ShooterPowers SHOOT_VAR = new ShooterSubsystem.ShooterPowers(30, 1,
                    0.5, 0);
        }

        public static final Slot0Configs ROLLER_PID_CONFIG = new Slot0Configs().withKP(0.2).withKS(0.23).withKV(0.24);
    ...
    public static final class Pivot {
        ...
        public static final class MotorConfigs {
            public static final MagnetSensorConfigs CANCODER_MAGNET_SENSOR = new MagnetSensorConfigs()
            ...
            public static final CANcoderConfiguration CANCODER_CONFIG = new CANcoderConfiguration()
                    .withMagnetSensor(CANCODER_MAGNET_SENSOR);

            public static final FeedbackConfigs PIVOT_FEEDBACK = new FeedbackConfigs()
                    .withFeedbackRemoteSensorID(Ports.CANCODER_PORT)
                    .withFeedbackSensorSource(FeedbackSensorSourceValue.RemoteCANcoder)
                    .withSensorToMechanismRatio(1.0)
                    .withRotorToSensorRatio(PIVOT_GEAR_RATIO);
            public static final SoftwareLimitSwitchConfigs PIVOT_SOFTWARE_LIMIT = new SoftwareLimitSwitchConfigs()
                    .withForwardSoftLimitThreshold(0.25)
                    .withReverseSoftLimitThreshold(-0.015)
                    .withForwardSoftLimitEnable(false)
                    .withReverseSoftLimitEnable(false);
            public static final VoltageConfigs PIVOT_VOLTAGE = new VoltageConfigs().withPeakForwardVoltage(5)
        ...
        public static final double PIVOT_GEAR_RATIO = (60 / 8) * (60 / 16) * (72 / 15); // FIXME placeholder values
    ...
    public static final class PoseEstimator {
        ...
        public static final List<Set<Integer>> POSSIBLE_FRAME_FID_COMBOS = List.of(Set.of(1, 2, 3, 4, 5),
                Set.of(6, 7, 8, 9, 10));
    ...
    public static final class NetworkWatchdog {
        ...
        public static final List<IPv4> TEST_IP_ADDRESSES = List.of(IPv4.internal(17), IPv4.internal(18),
                IPv4.internal(19));

        /**
         * The number of ms (sleep delta using oshi system uptime) to wait before
         * beginning to ping the
         * test IP.
         */
        ...
        /**
         * The number of ms to leave the switching pdh port off before turning it back
         * on as part of
        ...
        /**
         * The number of ms to wait before rerunning health checks after a failed check
         * which triggered
         * switch reboot.
         */
    ...
    public static final class Lights {
        ...
        public static final int NUM_LEDS = 89
    ...
    public static final class AutoAlign {
        ...
        public static final Pose2d BLUE_BOTTOM_MID = new Pose2d(5.84, 1.18,
                Rotation2d.fromDegrees(-BOTTOM_MID_ANGLE + 180));

        // Red team:
        // These poses have not been verified
        public static final Pose2d RED_AMP = new Pose2d(FIELD_WIDTH - 2.75, 7.31, Rotation2d.fromDegrees(-AMP_ANGLE));
        public static final Pose2d RED_TOP_MID = new Pose2d(FIELD_WIDTH - 5.8, 7.0,
                Rotation2d.fromDegrees(-TOP_MID_ANGLE));

        // These poses have been verified
        public static final Pose2d RED_STAGE = new Pose2d(FIELD_WIDTH - 4.17, 4.74,
                Rotation2d.fromDegrees(-STAGE_ANGLE));
        public static final Pose2d RED_BOTTOM_MID = new Pose2d(FIELD_WIDTH - 5.84, 1.18,
                Rotation2d.fromDegrees(-BOTTOM_MID_ANGLE));
        ...
        public static final PathConstraints CONSTRAINTS = new PathConstraints(3, 3, Units.degreesToRadians(540),
